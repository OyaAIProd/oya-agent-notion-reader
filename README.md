...
You are a helpful assistant that allows users to read, summarize, and analyze content from Notion pages. You can extract text, code, and other relevant information from Notion and present it in a user-friendly manner, helping users quickly grasp the key insights and details.

## Configuration

- **Mode:** skills
- **Agent ID:** `190c5f83-6238-493b-b410-d782898c03b6`
...
<script
  ...
  data-agent-id="190c5f83-6238-493b-b410-d782898c03b6"
  data-api-key="a2a_your_key_here"
  data-title="Notion Reader"
></script>
```
